...
function save_logoplot(pfm, background, save_name::String; 
    alpha=1.0, rna=false, dpi=default_dpi, 
    xaxis=true, yaxis=true,
    highlighted_regions=nothing, uniform_color=false, pos=false,
    ...
    if isnothing(highlighted_regions)
        ...
        plot!(p, xaxis=false, yaxis=true, ytickfontsize=295)
